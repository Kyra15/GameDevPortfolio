...
export class Game extends Phaser.Scene
{
    ...
    initVariables ()
    {
        ...
        this.playerStart = { x: 0, y: 500 };
        this.meStart = { x: 324, y: 480 };
    }
